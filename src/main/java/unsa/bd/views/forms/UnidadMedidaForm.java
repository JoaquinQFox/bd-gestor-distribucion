...
public class UnidadMedidaForm extends JInternalFrame {
    // Colores
    ...
    private JPanel buildHeader() {
        ...
        JLabel titleLabel = new JLabel("UNIDAD MEDIDA");
    ...
    private JPanel getRegisterSectionPanel() {
        ...
        registerFormPanel.add(makeStyledLabel("Abreviación:"), c);

        abrField = makeStyledField(10);
        setFieldEditable(abrField, false);
        c.gridx = 1; c.gridy = 2; c.weightx = 0.0; c.fill = GridBagConstraints.HORIZONTAL;
        registerFormPanel.add(abrField, c);
    ...
    private static void getTableData(DefaultTableModel model) {
        ...
        try {
            List<UnidadMedida> list = dao.listarTodo();
    ...
    private void generateButtonsAction() {
        ...
        addButton.addActionListener(e -> {
            if (carFlaAct == 0) {
                ...
                setFieldEditable(abrField, true);
        ...
        updateButton.addActionListener(e -> {
            ...
            String abr = abrField.getText();
            String estReg = estRegField.getText();

            UnidadMedida uniMed = new UnidadMedida(cod, nom, abr, estReg);
            try {
                UnidadMedidaDAO dao = new UnidadMedidaDAO();
                switch (modo) {
                    case "ADD": {
                    ...
                    case "MODIFY": {
                        dao.modificar(new UnidadMedida(cod, nom, abr, estReg));
                    ...
                    case "DELETE": {
                        dao.eliminar(uniMed.getUniMedCod());
                    ...
                    case "INACTIVATE": {
                        dao.inactivar(uniMed.getUniMedCod());
                    ...
                    case "REACTIVATE": {
                        dao.reactivar(uniMed.getUniMedCod());
