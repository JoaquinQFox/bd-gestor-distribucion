...
public class EstadoFacturaForm extends JInternalFrame {
    // Colores
    ...
    private static void getTableData(DefaultTableModel model) {
        ...
        try {
            List<EstadoFactura> ef = dao.listarTodo();
            for (EstadoFactura e : ef) {
    ...
    private void generateButtonsAction() {
        ...
        updateButton.addActionListener(e -> {
            ...
            EstadoFactura estFac = new EstadoFactura(cod, nom, estReg);
            try {
                EstadoFacturaDAO dao = new EstadoFacturaDAO();
                switch (modo) {
                    case "ADD": {
                    ...
                    case "MODIFY": {
                        dao.modificar(new EstadoFactura(cod, nom, estReg));
                    ...
                    case "DELETE": {
                        dao.eliminar(estFac.getEstFacCod());
                    ...
                    case "INACTIVATE": {
                        dao.inactivar(estFac.getEstFacCod());
                    ...
                    case "REACTIVATE": {
                        dao.reactivar(estFac.getEstFacCod());
