...
public class EstadoPedidoForm extends JInternalFrame {
    // Colores
    ...
    private void generateButtonsAction() {
        ...
        updateButton.addActionListener(e -> {
            ...
            EstadoPedido estPed = new EstadoPedido(cod, nom, estReg);
            try {
                EstadoPedidoDAO dao = new EstadoPedidoDAO();
                switch (modo) {
                    case "ADD": {
                    ...
                    case "MODIFY": {
                        dao.modificar(new EstadoPedido(cod, nom, estReg));
                    ...
                    case "DELETE": {
                        dao.eliminar(estPed.getEstPedCod());
                    ...
                    case "INACTIVATE": {
                        dao.inactivar(estPed.getEstPedCod());
                    ...
                    case "REACTIVATE": {
                        dao.reactivar(estPed.getEstPedCod());
